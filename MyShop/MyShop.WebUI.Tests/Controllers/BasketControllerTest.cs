...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "email.test.co.uk", ZipCode = "njjghjjw3" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("email.test.co.uk", "Forms"),null);
